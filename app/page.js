...
export default function Home() {
  return (
    <div> 
      ...
      width={1200} height={300} alt="background" />
      <Header/>
...
with our AI-powered interview prep</p>
      ...
      <div className="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36 mt-10">
...
<div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
  ...
  Describe the role or position you're preparing for. This will help the AI tailor relevant interview questions for your mock session.
</p>
      ...
      <Edit className='h-8 w-8'/>
        ...
        <p className="mt-1 text-sm text-gray-600">
  Make changes to your existing form details to better customize your AI interview mocker experience.
</p>
      ...
      <p className="mt-1 text-sm text-gray-600">
  Share your form with candidates and begin collecting their interview responses seamlessly in real-time.
</p>
